...
CREATE TABLE ai_usage_policy (
    ...
    daily_point_used INTEGER NOT NULL DEFAULT 0,
    daily_call_used INTEGER NOT NULL DEFAULT 0,
    daily_token_used INTEGER NOT NULL DEFAULT 0,
    window_start TEXT,
