...
INSERT INTO admin_role (role_code, display_name, description, permissions) VALUES
    ...
    ('operator', '运维', '日常运维操作（配置/踢人/重载/重启/任务）', 'admin:read,admin.config:write,admin.player:kick,admin.reload:logic,admin.reload:scripts,admin.restart,admin.task:manage'),
