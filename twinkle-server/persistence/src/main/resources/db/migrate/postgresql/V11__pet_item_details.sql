...
ALTER TABLE inventory_items ADD COLUMN pet_level SMALLINT NOT NULL DEFAULT 1;
ALTER TABLE inventory_items ADD COLUMN pet_closeness SMALLINT NOT NULL DEFAULT 0;
ALTER TABLE inventory_items ADD COLUMN pet_fullness SMALLINT NOT NULL DEFAULT 100;
