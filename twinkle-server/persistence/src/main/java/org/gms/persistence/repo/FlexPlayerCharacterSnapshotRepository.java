...
public final class FlexPlayerCharacterSnapshotRepository implements PlayerCharacterSnapshotRepository {
    ...
    public FlexPlayerCharacterSnapshotRepository(PlayerCharacterRecordMapper characterMapper,
    ...
    @Override
    public void save(PlayerCharacterRecord character, List<InventoryItemEntity> inventoryItems,
