...
public final class DefaultAdminAccessPolicy implements AdminAccessPolicy {
    ...
    public Policy resolve(HttpMethod method, String path) {
        ...
        if (method != HttpMethod.GET && method != HttpMethod.HEAD) {
            ...
            if ("/rewards".equals(relativePath)) return new Policy(false, AdminPermission.REWARD_GRANT);
