...
import org.gms.logic.admin.DefaultAccountOperations;
...
class AccountAdminControllerTest {
    ...
    void deleteAccountDisconnectsCharactersAndDelegatesCascade() {
        ...
        FakeAdmin admin = new FakeAdmin();
        AccountAdminController controller = new AccountAdminController(new DefaultAccountOperations(accounts, deletion, characters, admin));
    ...
    private static AccountAdminController controller(GameAccountRepository accounts,
                                                     ...
                                                     AdminService admin) {
        return new AccountAdminController(new DefaultAccountOperations(accounts, new MemoryDeletion(), characters, admin));
    }
