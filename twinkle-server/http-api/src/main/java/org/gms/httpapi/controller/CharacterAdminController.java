...
@Controller("/admin/v1/accounts/{accountId}/characters")
...
public final class CharacterAdminController {
    ...
    private static Map<String, Object> characterMap(Character character) {
        ...
        result.put("str", character.getStr());
        result.put("dex", character.getDex());
        result.put("int", character.getIntStat());
        result.put("luk", character.getLuk());
    ...
    private static Map<String, Object> inventoryMap(InventoryItemEntity item) {
        ...
        result.put("str", item.getStr());
        result.put("dex", item.getDex());
        result.put("int", item.getIntStat());
        result.put("luk", item.getLuk());
