...
public final class DefaultCharacterQueries implements CharacterQueries {
    ...
    public DefaultCharacterQueries(GameAccountRepository accountRepository,
    ...
    public HttpResponse<?> detail(long accountId, long characterId) {
        ...
        result.put("inventory", inventoryRepository.findByCharacterId(characterId).stream()
                .map(DefaultCharacterQueries::inventoryMap).toList());
        ...
        result.put("skills", skillRepository.findByCharacterId(characterId).stream()
                .map(DefaultCharacterQueries::skillMap).toList());
    ...
    private static Map<String, Object> questMap(QuestStatusEntity status,
        ...
        result.put("progress", allProgress.stream()
                ...
                .map(DefaultCharacterQueries::progressMap).toList());
        return result;
    }
