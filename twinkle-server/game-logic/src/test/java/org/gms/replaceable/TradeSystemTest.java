...
class TradeSystemTest {
    ...
    private final ItemSystem itemSystem = new DefaultItemSystem(versionGate, GameDataProvider.fixed(itemData, Map.of()));
    private final TradeSystem tradeSystem = new DefaultTradeSystem(versionGate, itemSystem);
