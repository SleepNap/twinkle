...
public class EquipmentSystemTest {
    ...
    private ItemSystem items() { return new DefaultItemSystem(versions, GameDataProvider.fixed(definitions, Map.of())); }
    private EquipmentSystem equipment() {
        return new DefaultEquipmentSystem(new DefaultProgressionSystem(versions)::accepts, GameDataProvider.fixed(definitions, Map.of()));
    }
