...
public class GameplayEconomyTest {
    ...
    private final ItemSystem items = new ItemSystem(versions,
    ...
    @Test public void questRewardIsAtomicAndCannotBeReplayed() {
        ...
        QuestSystem quests = new QuestSystem(versions);
    ...
    @Test public void apAndSpRejectOverspendingAndForeignSkillBranches() {
        ProgressionSystem progression = new ProgressionSystem(versions);
        character.setAp(5);
