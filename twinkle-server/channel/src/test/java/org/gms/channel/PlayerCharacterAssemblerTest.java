...
/**
 * 角色加载投影：data.PlayerCharacter（DB 存档）→ domain.PlayerCharacter（内存态角色）。
 * 覆盖 74 列标量映射、布尔列转换、逻辑版本来源。
 */
class PlayerCharacterAssemblerTest {

    private final PlayerCharacterAssembler loader = new PlayerCharacterAssembler(new DefaultVersionGate());
    ...
    void projectsAllScalarFields() {
        ...
        PlayerCharacter chr = loader.fromData(db);
    ...
    void projectsAllInventoryItems() {
        ...
        PlayerCharacterAssembler inventoryLoader = new PlayerCharacterAssembler(new DefaultVersionGate(), repository);
        org.gms.persistence.entity.PlayerCharacterRecord db = new org.gms.persistence.entity.PlayerCharacterRecord();
        db.setId(9L);
        db.setName("Hero");
        db.setEquipSlots(24);
        ...
        PlayerCharacter chr = inventoryLoader.fromData(db);
    ...
    void projectsQuestStatusesAndProgress() {
        ...
        PlayerCharacterAssembler questLoader = new PlayerCharacterAssembler(
                new DefaultVersionGate(), null, repository);
        org.gms.persistence.entity.PlayerCharacterRecord db = new org.gms.persistence.entity.PlayerCharacterRecord();
        db.setId(9L);
        db.setName("Hero");

        PlayerCharacter chr = questLoader.fromData(db);
    ...
    void projectsSkills() {
        ...
        PlayerCharacterAssembler skillLoader = new PlayerCharacterAssembler(
                new DefaultVersionGate(), null, null, repository);
        org.gms.persistence.entity.PlayerCharacterRecord db = new org.gms.persistence.entity.PlayerCharacterRecord();
        db.setId(9L);
        db.setName("Hero");

        PlayerCharacter chr = skillLoader.fromData(db);
